...
def delete_sagemaker_endpoint(endpoint_name: str, region_name: str) -> None:
    ...
    Args:
        ...
        region_name (str): The AWS region where the SageMaker endpoint is located.
    """
    # Create SageMaker client
    sagemaker_client = boto3.client('sagemaker', region_name=region_name)

    # Ask for user confirmation
    confirmation = input(f"Are you sure you want to delete the endpoint '{endpoint_name}'? Type 'Yes' to confirm: ")
