...
# This file implements the scoring service shell. You don't necessarily need
# to modify it for various
...
def start_server():
    ...
    # container logs
    subprocess.check_call(["ln", "-sf", "/dev/stdout",
                           "/var/log/nginx/access.log"])
    subprocess.check_call(["ln", "-sf", "/dev/stderr",
